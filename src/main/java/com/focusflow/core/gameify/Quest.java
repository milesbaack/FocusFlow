 ...
 * Similar to a Project, a Quest is completed when all of its Tasks are
 * completed.
...
public class Quest {
    ...
    /**
     * Creates a new Quest with the specified title, description, achievement reward
     * and base XP.
     * 
     * @param title             The title of the quest
     * @param description       The description of the quest
     * @param rewardAchievement The achievement to award when completed (can be
     *                          null)
    ...
    public int calculateXpReward() {
        ...
        // Formula: Base XP + (Task Bonus * Number of Tasks) + (Subtask Bonus * Number
        // of Subtasks)
