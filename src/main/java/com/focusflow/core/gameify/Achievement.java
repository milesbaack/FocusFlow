...
public enum Achievement {
     ...
     * Description: "Complete thirty-two sessions in a row... time to go to
     * sleep..."
     * Name: "Sixteen hours later"
     */
    THIRTY_TWO_SESSIONS_IN_A_ROW(4006, "Complete thirty-two sessions in a row... time to go to sleep...",
            "Sixteen hours later"),
     ...
     * @param description the textual description of what needs to be done to unlock
     *                    this achievement
