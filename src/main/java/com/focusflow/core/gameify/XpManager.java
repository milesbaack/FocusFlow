 ...
 * <p>
 * This class tracks a user's XP, handles level progression, and provides
 * methods
 * to query level information and progression status. It uses a fully dynamic XP
 * calculation system allowing for unlimited level progression without hardcoded
 * values.
 * </p>
 * 
 * @author Miles Baack
...
public class XpManager {
     ...
     * @throws IllegalArgumentException if initialXp is negative or initialLevel is
     *                                  less than 1
     */
     ...
     * @return {@code true} if adding XP resulted in a level up, {@code false}
     *         otherwise
     ...
     * <p>
     * XP requirements are calculated using a formula that produces exponential
     * growth:
