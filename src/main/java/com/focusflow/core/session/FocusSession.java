...
public class FocusSession implements Serializable {
    ...
    /**
     * Gets the ID of the task associated with this session.
     * This is an alias for getAssociatedTaskId() for compatibility.
     * 
     * @return The associated task ID
     */
    ...
    /**
     * Marks this session as consecutive, indicating it follows a previous session
     * and break.
     * 
     ...
     * @param toleranceMinutes       Allowed tolerance in minutes (earlier or later
     *                               than expected)
