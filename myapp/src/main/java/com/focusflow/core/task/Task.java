...
public class Task implements Serializable, TaskWithStatus {
    ...
    /**
     * Gets all subtasks associated with this task.
     * 
    ...
    /**
     * Adds a listener to receive notifications when this task changes.
     * 
     ...
     */
    public boolean removeEventListener(TaskListener listener) {
        return listeners.remove(listener);
    }
    
    /**
     * Adds a listener to receive notifications when this task changes.
     * This is an alias for addEventListener to maintain compatibility.
     * 
     * @param listener The listener to add
     */
    ...
    /**
     * Removes a listener from this task.
     * This is an alias for removeEventListener to maintain compatibility.
     * 
     * @param listener The listener to remove
     */
    ...
    /**
     * Notifies all registered listeners that this task has been completed.
     */
    private void notifyTaskCompleted() {
        for (TaskListener listener : new ArrayList<>(listeners)) {
            listener.onTaskCompleted(this);
        }
    }
    
    /**
     * Notifies all registered listeners that this task's progress has been updated.
     */
    private void notifyTaskProgressUpdated() {
        for (TaskListener listener : new ArrayList<>(listeners)) {
            listener.onTaskProgressUpdated(this);
        }
    }
    
    /**
     * Notifies all registered listeners that this task has been deleted.
     */
    private void notifyTaskDeleted() {
        for (TaskListener listener : new ArrayList<>(listeners)) {
            listener.onTaskDeleted(this);
        }
    }
