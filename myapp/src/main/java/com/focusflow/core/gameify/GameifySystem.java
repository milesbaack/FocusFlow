...
public class GameifySystem {
     ...
     * @return true if the achievement was successfully unlocked, false if already unlocked or not found
     */
     ...
     * @return true if the quest was successfully completed, false if not found in active quests
     */
